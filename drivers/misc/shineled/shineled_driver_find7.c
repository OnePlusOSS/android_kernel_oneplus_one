...
/*OPPO yuyi 2014-01-07 delete begin for abandon red and green light*/
		//SN3193_SetBrightness(RED_SLED,value);
/*OPPO yuyi 2014-01-07 delete end for abandon red and green light*/
		color_R = value;
/*OPPO yuyi 2014-01-07 add begin for abandon red and green light*/
		brightness_time++;
/*OPPO yuyi 2014-01-07 add end for abandon red and green light*/
	}
...
/*OPPO yuyi 2014-01-07 add begin for abandon red and green light*/
	...
	if(shine_debug) {
			printk("shineled---- brightness_time  = %d\n",brightness_time);
		}
/*OPPO yuyi 2014-01-07 add end for abandon red and green light*/
}
